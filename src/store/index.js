...
import { API_KEY, TMDB_BASE_URL } from "../utils/constraints";
...
export const getUserLikedMovies = createAsyncThunk(
  ...
  async (email) => {
    const {
      ...
      `https://flixxit-server-zatq.onrender.com/api/user/liked/${email}`
    );
    return movies;
  }
);
...
export const removeFromLikedMovies = createAsyncThunk(
  ...
  async ({ email, movieId }) => {
    const {
      ...
      `https://flixxit-server-zatq.onrender.com/api/user/delete`,
      {
        email,
        movieId,
      }
